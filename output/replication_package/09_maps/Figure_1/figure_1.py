...
df = pd.read_csv('historical_losses.zip')
...
df_counties = gpd.read_file('Boundaries/cb_2020_us_county_500k_lower48_proj.zip')
df_counties = df_counties.to_crs(5070)

### Read states shapefile to Pandas DataFrame
df_states = gpd.read_file('Boundaries/cb_2018_us_state_20m_lower48_proj.zip')
