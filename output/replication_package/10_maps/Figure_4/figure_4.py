...
boundaries_dir = os.path.join(SCRIPT_DIR, 'Boundaries')

### Initialize path to states shapefile
states_shp_uri = os.path.join(SCRIPT_DIR, 'Boundaries', 'cb_2018_us_state_20m_lower48_proj.zip')

### Read states shapefile to GeoPandas dataframe
df_states = gpd.read_file(states_shp_uri)

### Initialize path to counties shapefile
counties_shp_uri = os.path.join(SCRIPT_DIR, 'Boundaries', 'cb_2020_us_county_500k_lower48_proj.zip')
...
### Initialize path to loan data file
xlsx_uri = os.path.join(SCRIPT_DIR, 'loan_data.xlsx')
...
df_fsf = pd.read_csv(os.path.join(SCRIPT_DIR, 'fs_data.csv'))
...
for i in range (1,5):
    ...
    os.path.join(SCRIPT_DIR, 'coeffs', f'delinq90_inun_fico_{i}_static.csv'))
...
### Save figure
fn = os.path.join(SCRIPT_DIR, 'figure_4.png')
